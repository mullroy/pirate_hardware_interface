This patch is required for using XCode 15 with Qt5. The patch fixes internal
so the qmake build script can run properly. 

If you're using a newer version than XCode 11, incompatibilities with Qt 
